...
{
    /// <summary>
    /// PID + Smith predictor on UWB ranges (PidSpring mode). Skips mother→child.
    /// Uses last-frame real displacement, not lastAppliedForce (that bug is on mission-i-moduly).
    /// </summary>
    /// <remarks>
